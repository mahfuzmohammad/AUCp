...
import pytorch_msssim.ssim as ssim_p
...
if __name__ == '__main__':
    ...
    loss = SSIMLoss(size_average=True)(img1, img2)

    # ssim_l = SSIM(data_range=1, size_average=False, channel=3)(img1, img2)
    ssim_l = ssim_p(img1, img2, data_range=1, size_average=False)

    print(loss.shape)
    print(SSIMLoss(size_average=True)(img1, img1))
    print(SSIM(data_range=1, size_average=False, channel=3)(img1, img1))
    print(ssim_l, loss)
