...
base_parser.add_argument('-g', '--gpu', type=int, default=0, help='gpu')
...
base_parser.add_argument('--resume_path', type=str,
                         ...
                         ' in the format <entity>/<project>/<run_id>/<model_name>', default='./')

# Data settings
base_parser.add_argument('-d', '--train_dataset', type=str,
...
base_parser.add_argument('--save_frequency', type=int, default=100,
                         help='Model checkpointing frequency')
base_parser.add_argument('--num_images_log', type=int,
                         default=20, help='Number of images to log')

# Hyperparameters
base_parser.add_argument('--lr', type=float, default=5e-4, help='Learning rate')
